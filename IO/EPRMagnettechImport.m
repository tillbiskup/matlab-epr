...
parameterMatching = {
    ...
    'XUnit','parameters.field.start.unit'; ...
    'XUnit','parameters.field.stop.unit'; ...
    'MicrowavePower','parameters.bridge.power.value'; ...
    'MwFreq','parameters.bridge.MWfrequency.value'; ...
    'Accumulations','parameters.signalChannel.accumulations'; ...
    };
...
for k=1:length(parameterMatching)
    if isfield(parameters,parameterMatching{k,1})
        data = commonSetCascadedField(...
            ...
            parameters.(parameterMatching{k,1}));
    end
end
